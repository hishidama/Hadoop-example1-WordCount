package example1.afw.batchapp.afwWordcountBatch.wordcount.fileio.afwout.epilogue;
...
import example1.afw.batchapp.afwWordcountBatch.wordcount.fileio.afwout.epilogue.result.StageMapper0;
...
public final class StageClient extends AbstractStageClient {
    ...
    @Override protected List<StageInput> getStageInputs() {
        ...
        results.add(new StageInput("target/hadoopwork/${execution_id}/afwWordcountBatch/wordcount/stage0001/result0-*", 
