package test.jobflow.bid.wordcount2.fileio.afwout.epilogue;
...
import test.jobflow.bid.wordcount2.fileio.afwout.epilogue.result.StageMapper0;
/**
...
public final class StageClient extends AbstractStageClient {
    ...
    @Override protected List<StageInput> getStageInputs() {
        ...
        results.add(new StageInput("target/testdriver/hadoopwork/bid/wordcount2/stage0001/result0-*", 
