...
import example1.afw.jobflow.TextModelInputFormat;
...
public final class StageClient extends AbstractStageClient {
    ...
    @Override protected String getStageOutputPath() {
        return "target/hadoopwork/${execution_id}/afwWordcountBatch2/wordcount2/stage0001";
    }
    @Override protected List<StageInput> getStageInputs() {
        List<StageInput> results = new ArrayList<StageInput>();
        results.add(new StageInput("example1/input/*", TextModelInputFormat.class, StageMapper1.class));
        return results;
    }
